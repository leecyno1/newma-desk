...
process.on('uncaughtException', (e) => {
    try {
        process.stderr.write('RSSHub uncaughtException: ' + (e instanceof Error ? e.stack || e.message : String(e)) + '\n');
    } catch {
        // Process is already failing; there is no safe logger fallback.
    }
    process.exit(1);
});
