  ...
  return (
    <div>
      ...
      <GlassCard className="mb-6">
        <div className="mb-3 flex gap-2">
          <input
            ...
            className="w-60 rounded-lg border border-border bg-card/80 px-3 py-2 text-sm outline-none placeholder:text-muted-foreground/70 focus:border-primary/50"
          />
      ...
      <GlassCard glow className="mb-6">
        ...
        {review ? (
          <>
            <ResearchText content={review} className="mt-4" />
