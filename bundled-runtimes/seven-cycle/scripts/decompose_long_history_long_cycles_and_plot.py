...
"""
Decompose long-history annual series into long-cycle components (200m/100m)
...
Outputs:
- output/long_history_long_cycles/summary.csv
- output/long_history_long_cycles/components_<id>.parquet
- output/long_history_long_cycles/phases_<id>.parquet
- output/long_history_long_cycles/plots/<id>_200_100.png
"""
...
def prepare_regular_series(s: pd.Series, *, min_points: int = 120, max_missing_frac: float = 0.2) -> pd.Series | None:
    s = s.sort_index()
...
def main() -> None:
    ...
    panel_path = data_dir / "indicator_panel_annual_long_history_year.parquet"
    ...
    out_base = out_dir / "long_history_long_cycles"
