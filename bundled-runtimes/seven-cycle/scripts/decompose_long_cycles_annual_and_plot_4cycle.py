...
"""
Annual-frequency decomposition for the 4-cycle framework long bands (200m/100m).

Why:
- Monthly panel is truncated to post-2000 by design, which is too short for 200m (≈16-18y).
- Annual panel spans ~1960-2024 for many series; better suited to assess 200m/100m bands.
...
Outputs:
- output/cycle_selected_annual_long_4cycle/summary.csv
- output/cycle_selected_annual_long_4cycle/plots/<id>_annual_long_4cycle.png
"""
...
def main() -> None:
    ...
    reps = reps[(reps["cycle_freq_used"] == "A") & (reps["cycle_months"].isin(TARGET_MONTHS))]
    ...
    out_base = out_dir / "cycle_selected_annual_long_4cycle"
    ...
    for id_ in ids:
        ...
        plot_path = plot_dir / f"{sanitize(id_)}_annual_long_4cycle.png"
