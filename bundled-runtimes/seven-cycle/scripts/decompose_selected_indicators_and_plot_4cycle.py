...
"""
Decompose selected indicators into the 4-cycle components (200/100/42/20m)
...
Outputs:
- output/cycle_selected_4cycle/summary.csv
- output/cycle_selected_4cycle/components_<id>.parquet
- output/cycle_selected_4cycle/phases_<id>.parquet
- output/cycle_selected_4cycle/plots/<id>_4cycle.png
"""
...
def main() -> None:
    ...
    selected_path = out_dir / "cycle_representative_indicators_4cycle.csv"
    mapping_path = out_dir / "indicator_universe_latest_mapped.csv"

    selected = pd.read_csv(selected_path)
    mapping = pd.read_csv(mapping_path).drop_duplicates(subset=["id"])
    ...
    for id_ in ids:
        ...
        plot_path = plot_dir / f"{base}_4cycle.png"
