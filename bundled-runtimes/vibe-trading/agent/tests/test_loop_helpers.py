...
class TestBacktestAutoSummary:
    def test_formats_successful_run_card_summary(self, tmp_path: Path) -> None:
        ...
        summary = _backtest_auto_summary(run_dir)

        assert "Backtest Completed" in summary
        assert "000001.SZ" in summary
        assert "2024-01-01 to 2024-01-31" in summary
        assert "tushare" in summary
