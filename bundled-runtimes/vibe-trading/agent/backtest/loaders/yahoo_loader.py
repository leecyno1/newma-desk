...
from backtest.loaders._symbol_utils import (
    is_hk_equity_symbol,
    is_us_equity_symbol,
    yahoo_project_symbol,
)
...
def _is_supported(code: str) -> bool:
    ...
    return (
        is_us_equity_symbol(cleaned)
        or is_hk_equity_symbol(cleaned)
        or cleaned.endswith((".NS", ".BO"))
    )
