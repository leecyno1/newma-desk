...
# Overseas equity ordering follows the global-stock-data Skill exactly:
# US daily bars prefer Sina and fall back to direct Yahoo chart; HK daily bars
# use direct Yahoo chart. Tushare/yfinance do not provide an allowed overseas
# K-line route and therefore must never appear in either auto fallback chain.
