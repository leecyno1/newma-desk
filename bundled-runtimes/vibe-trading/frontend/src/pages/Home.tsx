...
import { isVibeDeskEmbedded, openVibeDeskCopilot } from "@/lib/vibedesk";
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-8">
      <div className="max-w-2xl text-center space-y-6">
        <h1 className="text-4xl font-bold tracking-tight" data-mod-page-title>{t("home.title")}</h1>
        <p className="text-lg text-muted-foreground" data-mod-page-title>{t("home.subtitle")}</p>
        {isVibeDeskEmbedded ? (
          <button
            type="button"
