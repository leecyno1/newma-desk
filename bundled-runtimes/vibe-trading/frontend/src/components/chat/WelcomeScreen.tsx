...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    color: "text-warning border-warning/30 hover:border-warning/60 hover:bg-warning/5",
    examples: [
      {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-8 text-center">
      ...
      <div className="space-y-3">
        <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-primary to-warning shadow-lg shadow-primary/10 ring-1 ring-primary/30">
