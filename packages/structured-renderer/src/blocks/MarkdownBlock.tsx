...
import type { MarkdownBlock as MarkdownBlockContract } from "@vibe-visualization/contracts";
...
export function MarkdownBlock({ block, data }: MarkdownBlockProps) {
  ...
  return (
    <section className="vv-view-block vv-markdown-block" data-block-id={block.id}>
